    ...
    public function abrirConexao() {
        try {
            if (!self::$flagGlobal_conexao) {
                $array_config = Configuracao::getInstance()->getValor('banco_de_dados');
                ...
                if (Configuracao::getInstance()->getValor('producao')) {
                    ...
                    mysqli_real_connect(self::$conn, $array_config['host'], $array_config['user'], $array_config['password'], $array_config['database'], null, null, MYSQLI_CLIENT_SSL);
                } else {

                    self::$conn = mysqli_connect($array_config['host'], $array_config['user'], $array_config['password'], $array_config['database']);
                }
